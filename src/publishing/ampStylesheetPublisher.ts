...
export class AmpStylesheetPublisherPlugin implements HtmlPagePublisherPlugin {
    ...
    public async apply(document: Document, page: HtmlPage): Promise<void> {
        ...
        let css = "*{position:relative}body,html{height:100%;width:100%;display:flex;flex-direction:column}.stretch{flex:1;height:100%}layout,main{flex:1;flex-direction:column;display:flex}.block{display:block;flex-basis:100%} html:not([amp4ads]),html:not([amp4ads]) body {height: 100% !important;}";
